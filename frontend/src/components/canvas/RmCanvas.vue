...
import RmSelectedBox from './Util/RmSelectedBox.vue';
import { AnchorClickEvent } from './Util/RmAnchors.vue';
...
function startAddEdge(e: AnchorClickEvent) {
  ...
  let direction: 'lineX' | 'lineY';

  if (e.anchor.id === 'bottom' || 
  e.anchor.id === 'top') {
    direction = 'lineY';
  }
  else {
